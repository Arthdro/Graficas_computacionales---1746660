...
int main()
{
    ...
    unsigned char* data = stbi_load("C:\\gl\\resources\\textures\\rubik_texture.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
...
void reloadVAO(int faces[], float *vertices)
{
  ...
  */
  float vbo[] = {
       ...
       -0.5f,  0.5f,  0.5f,  textCoords[faces[1]][9], textCoords[faces[1]][9],
